...
const T = {
  ...
  'nav.integrations': ['Integratsiyalar', 'Интеграциялар', 'Интеграции'],
  ...
  'rp.otherIncome': ['Boshqa daromadlar', 'Бошқа даромадлар', 'Прочие доходы'],
  'rp.financeExp': ['Moliyaviy xarajatlar', 'Молиявий харажатлар', 'Финансовые расходы'],
  'rp.preTax': ['Soliqqacha foyda', 'Солиққача фойда', 'Прибыль до налога'],
  ...
  // ─── Integrations (DIDOX / Faktura / SOLIQ Servis) ───────────────────
  'int.title': ['Integratsiyalar', 'Интеграциялар', 'Интеграции'],
  'int.sub': [
    'Soliq va e-hujjat tizimlariga ulanish',
    'Солиқ ва е-ҳужжат тизимларига уланиш',
    'Подключение к налоговым и ЭДО-системам',
  ],
  'int.didox.desc': [
    'O‘zbekistondagi eng yirik e-hujjat almashinuvi tizimi',
    'Ўзбекистондаги энг йирик е-ҳужжат алмашинуви тизими',
    'Крупнейшая система обмена ЭДО в Узбекистане',
  ],
  'int.faktura.desc': [
    'E-Faktura — rasmiy elektron hisobvaraq-faktura',
    'E-Faktura — расмий электрон ҳисобварақ-фактура',
    'E-Faktura — официальный электронный счёт-фактура',
  ],
  'int.soliqservis.desc': [
    'Soliq hujjatlari uchun tijorat API xizmati',
    'Солиқ ҳужжатлари учун тижорат API хизмати',
    'Коммерческий API-сервис для налоговых документов',
  ],
  'int.active': ['Faol', 'Фаол', 'Активный'],
  'int.setActive': ['Faol qilish', 'Фаол қилиш', 'Сделать активным'],
  'int.configure': ['Sozlash', 'Созлаш', 'Настроить'],
  'int.connected': ['Ulangan', 'Уланган', 'Подключено'],
  'int.demoMode': ['Demo rejim', 'Демо режим', 'Демо-режим'],
  'int.notConnected': ['Ulanmagan', 'Уланмаган', 'Не подключено'],
  'int.docs': ['Hujjatlar', 'Ҳужжатлар', 'Документация'],
  'int.field.token': ['API token', 'API токен', 'API токен'],
  'int.field.login': ['Login', 'Логин', 'Логин'],
  'int.field.password': ['Parol', 'Парол', 'Пароль'],
  'int.save': ['Saqlash', 'Сақлаш', 'Сохранить'],
  'int.disconnect': ['Uzish', 'Узиш', 'Отключить'],
  'int.test': ['Ulanishni tekshirish', 'Уланишни текшириш', 'Проверить подключение'],
  'int.testOk': ['Ulanish muvaffaqiyatli', 'Уланиш муваффақиятли', 'Подключение успешно'],
  'int.testDemo': [
    'Demo: kalitsiz sinov rejimi',
    'Демо: калитсиз синов режими',
    'Демо: тестовый режим без ключа',
  ],
  'int.sendTest': ['Test faktura yuborish', 'Тест фактура юбориш', 'Отправить тест-фактуру'],
  'int.sending': ['Yuborilmoqda...', 'Юборилмоқда...', 'Отправка...'],
  'int.sentOk': ['Faktura yuborildi', 'Фактура юборилди', 'Фактура отправлена'],
  'int.sentDemo': [
    'Demo: faktura simulyatsiya qilindi (imzolangan)',
    'Демо: фактура симуляция қилинди (имзоланган)',
    'Демо: фактура симулирована (подписана)',
  ],
  'int.docId': ['Hujjat raqami', 'Ҳужжат рақами', 'Номер документа'],
  'int.needKeys': [
    'Haqiqiy yuborish uchun rasmiy API kaliti kerak. Hozircha demo rejimda ishlaydi.',
    'Ҳақиқий юбориш учун расмий API калити керак. Ҳозирча демо режимда ишлайди.',
    'Для реальной отправки нужен официальный API-ключ. Пока работает в демо-режиме.',
  ],
  'int.eriNote': [
    'Yuborishdan oldin faktura ERI (E-IMZO) bilan imzolanadi.',
    'Юборишдан олдин фактура ЭРИ (E-IMZO) билан имзоланади.',
    'Перед отправкой фактура подписывается ЭЦП (E-IMZO).',
  ],
  'int.signSkipped': [
    'ERI topilmadi — imzosiz (demo) yuborildi',
    'ЭРИ топилмади — имзосиз (демо) юборилди',
    'ЭЦП не найден — отправлено без подписи (демо)',
  ],
} as const
